...
/// @title The Myths DAO proxy contract
...
/*
LICENSE
MythsDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
MythsDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract MythsDAOProxy is MythsDAOProxyStorage, MythsDAOEvents {
    constructor(
        address timelock_,
        address myths_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(
            msg.sender == admin,
            "MythsDAOProxy::_setImplementation: admin only"
        );
        require(
            implementation_ != address(0),
            "MythsDAOProxy::_setImplementation: invalid implementation address"
        );
