...
/// @title The Myths NFT descriptor
...
contract MythsDescriptor is IMythsDescriptor, Ownable {
    ...
    // Whether or not new Myth parts can be added
    ...
    // Myth Color Palettes (Index => Hex Colors)
    mapping(uint8 => string[]) public override palettes;

    // Myth Backgrounds (Hex Colors)
    string[] public override backgrounds;

    // Myth Bodies (Custom RLE)
    bytes[] public override bodies;

    // Myth Accessories (Custom RLE)
    bytes[] public override accessories;

    // Myth Heads (Custom RLE)
    bytes[] public override heads;

    // Myth Glasses (Custom RLE)
    ...
    /**
     * @notice Get the number of available Myth `backgrounds`.
     */
    ...
    /**
     * @notice Get the number of available Myth `bodies`.
     */
    ...
    /**
     * @notice Get the number of available Myth `accessories`.
     */
    ...
    /**
     * @notice Get the number of available Myth `heads`.
     */
    ...
    /**
     * @notice Get the number of available Myth `glasses`.
     */
    ...
    /**
     * @notice Batch add Myth backgrounds.
    ...
    /**
     * @notice Batch add Myth accessories.
     * @dev This function can only be called by the owner when not locked.
     */
    ...
    /**
     * @notice Given a token ID and seed, construct a token URI for an official Myths DAO myth.
     * @dev The returned value may be a base64 encoded data URI or an API URL.
     */
    function tokenURI(uint256 tokenId, IMythsSeeder.Seed memory seed)
        external
        view
        override
    ...
    /**
     * @notice Given a token ID and seed, construct a base64 encoded data URI for an official Myths DAO myth.
     */
    function dataURI(uint256 tokenId, IMythsSeeder.Seed memory seed)
        public
        view
        override
        returns (string memory)
    {
        string memory mythId = tokenId.toString();
        string memory name = string(abi.encodePacked("Myth ", mythId));
        string memory description = string(
            abi.encodePacked("Myth ", mythId, " is a member of the Myths DAO")
        );
     ...
     */
    function generateSVGImage(IMythsSeeder.Seed memory seed)
        external
        view
        override
        returns (string memory)
    ...
    /**
     * @notice Get all Myth parts for the passed `seed`.
     */
    function _getPartsForSeed(IMythsSeeder.Seed memory seed)
        internal
        view
